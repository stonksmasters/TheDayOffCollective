...
export const sendTransaction = async (wallet, amount, cartItems) => {
    ...
    try {
        ...
        const confirmation = await connection.confirmTransaction(signature, 'finalized', { commitment: 'finalized', timeout: 120000 }); // Increased timeout
        console.log("[SolanaTransactions] Transaction confirmed with status:", confirmation);
